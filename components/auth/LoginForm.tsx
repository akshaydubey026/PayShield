...
type LoginFormProps = {
  /** Hide “No account? Register” when tabs handle navigation */
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full border-white/15 bg-white/[0.02] transition-all duration-300 hover:scale-[1.02] active:scale-95 hover:border-white/25 hover:bg-white/[0.06]"
        disabled
      >
